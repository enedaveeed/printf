...
int obtain_print(const char *fmt, int *i,
...
int print_integer(va_list types, char buffer[],
	int flags, int width, int precision, int sizer)
...
int calculate_flags(const char *format, int *j);
...
/* width handler */
int is_onwer(char c, char buffer[],
	int flags, int width, int precision, int size);
...
int hexadecimal_decode(char, char[], int);
int idigit_value(char);
